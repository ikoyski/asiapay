...
<body>
	...
	<div class="container">
		...
		<div class="starter-template">
			...
			<p>
			 The <a href="/asiapay/actuator/health" target="_blank">/asiapay/actuator/health</a> endpoint provides basic information about the application&apos;s health.
			...
			<p>
			 The build and version information can be checked by calling the <a href="/asiapay/actuator/info" target="_blank">/asiapay/actuator/info</a> endpoint. This allows checking of the git tags, maven version, build date etc.
			</p>			
		</div>
