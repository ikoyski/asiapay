<select class="form-control" id="gatewayUrl" name="gatewayUrl">
    <optgroup label="PesoPay">
     	...
     	<option selected="selected">https://test.pesopay.com/b2cDemo/eng/payment/payForm.jsp</option>
     	<option>https://test2.pesopay.com/b2cDemo/eng/payment/payForm.jsp</option>
    ...
    <optgroup label="PayDollar">
     	...
     	<option>https://test2.paydollar.com/b2cDemo/eng/payment/payForm.jsp</option>
    ...
    <optgroup label="SiamPay">
     	...
     	<option>https://test2.siampay.com/b2cDemo/eng/payment/payForm.jsp</option>
     	<option>https://sit.siampay.com/b2cDemo/eng/payment/payForm.jsp</option>
    </optgroup>
    <optgroup label="BimoPay">
        <option>https://www.bimopay.com/b2c2/eng/payment/payForm.jsp</option>
   </optgroup>
</select>