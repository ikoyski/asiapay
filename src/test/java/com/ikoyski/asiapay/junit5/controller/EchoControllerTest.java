package com.ikoyski.asiapay.junit5.controller;

import static com.ikoyski.asiapay.service.RequestUtils.asJsonString;
...
import com.ikoyski.asiapay.controller.AsiapayControllerAdvice;
...
public class EchoControllerTest {
  ...
  void testEchoBodyIsNotJson() throws Exception {
    ...
    mockMvc
        ...
        // validates body fields
        .andExpect(jsonPath("$.message", is(AsiapayControllerAdvice.JSON_PARSE_ERROR))); 
  }
